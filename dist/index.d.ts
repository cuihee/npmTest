export declare namespace Sippreep {
    namespace Viewing {
        ...
        class Document {
            ...
            static load(documentId: string, successCallback: (doc: Document) => void, errorCallback: (errorCode: ErrorCodes, errorMsg: string, messages: any[]) => void, accessControlProperties?: any): void;
        ...
        class FragmentList {
             ...
             */
            fragments: {
                fragId2dbId: Int32Array;
            };
            /**
             * @deprecated 此功能为私有属性，不建议使用
             */
            db2ThemingColor: {
                [dbid: number]: undefined | THREE.Vector4;
            };
        ...
        class Model {
             ...
             */
            getExternalIdMapping(onSuccessCallback: (idMapping: {
                [key: string]: number;
            }) => void, onErrorCallback: () => void): any;
            getFastLoadList(): any;
            /**
        ...
        interface PropertyDatabase {
             ...
             */
            enumAttributes(cb: (attrId: number, attrDef: {
                name: string;
            }, attrRaw: any) => void): void;
            /**
        ...
        class Viewer3D {
            ...
            loadDocumentNode(avDocument: Document, manifestNode: any, options: object): Promise<Model>;
            unloadDocumentNode(manifestNode: any): boolean;
            ...
            setView(viewNode: any, options: object): boolean;
        ...
        class GuiViewer3D extends Viewer3D {
            ...
            setModelStructurePanel(modelStructurePanel: any): void;
            setLayersPanel(layersPanel: any): void;
            setPropertyPanel(propertyPanel: any): void;
            getPropertyPanel(createDefault?: boolean): any;
            setSettingsPanel(settingsPanel: any): void;
            getSettingsPanel(createDefault?: boolean, model?: Model): any;
        ...
        namespace UI {
          ...
          */
                ...
                addCheckbox(tabId: string, caption: string, initialState: boolean, onchange: () => void, options?: object): string;
                addControl(tabId: string, control: object | HTMLElement, options: object | undefined): string;
                addDropDownMenu(tabId: string, caption: string, items: MenuItem[], initialItemIndex: number, onchange: () => void, options: object | undefined): string;
                addSlider(tabId: string, caption: string, min: number, max: number, initialValue: number, onchange: () => void, options: object | undefined): string;
